...
\citeauthor{Rastogi1994} (\citeyear{Rastogi1994}) (\citeauthor{Rastogi1994} \citeyear{Rastogi1994}より引用) は、低緯度地域における地磁気H成分の季節変化を解析し、Sq電流系の強度が季節によって変動することを報告している。
...
\begin{figure}[htbp]
  ...
  \caption{Seasonal variations of Sq current system (\citeauthor{Rastogi1994} \citeyear{Rastogi1994}より引用).}
